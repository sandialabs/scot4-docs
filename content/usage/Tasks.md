...
Tasks are very lightweight and do not provide the ability to assign to others, do not have deadlines, and do not provide reminders or other workflow features.  All tasks can be viewed by anyone that has read permissions to them.  The idea is that if you want to help, you should select an open task and take ownership of it, thus signalling that you will work on it.  You can attach the results of your work as a child Entry to the task and close the task when finished.
